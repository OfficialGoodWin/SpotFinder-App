...
export const outdoorStyle = {
  ...
  layers: [
    ...
    // ── Roads — casings ───────────────────────────────────────────────────
    { id:'rc-motorway', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','motorway'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#3d7a20',
        'line-width':['interpolate',['linear'],['zoom'],6,2.5,10,5,14,12.5,18,30] } },
    { id:'rc-trunk', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','trunk'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#1a5ad0',
        'line-width':['interpolate',['linear'],['zoom'],6,2,10,4,14,8.75,18,24] } },
    { id:'rc-primary', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','primary'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#b85a00',
        'line-width':['interpolate',['linear'],['zoom'],6,1.5,10,3.5,14,8.75,18,21] } },
    { id:'rc-secondary', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','secondary'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#a87800',
        'line-width':['interpolate',['linear'],['zoom'],6,1,10,3,14,7.5,18,18] } },
    { id:'rc-secondary-local', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','secondary'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':['case',
      ...
      'line-width':['interpolate',['linear'],['zoom'],6,0.8,10,2.5,14,5,18,12] } },
    { id:'rc-tertiary', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','tertiary'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#a09070',
        'line-width':['interpolate',['linear'],['zoom'],8,0.8,10,2.5,14,6.25,18,15] } },
    { id:'rc-local', type:'line', source:'v', 'source-layer':'transportation',
      filter:['in','class','unclassified','minor'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#b8b0a0',
        'line-width':['interpolate',['linear'],['zoom'],12,0.5,10,2,14,5,18,12] } },
    { id:'rc-street', type:'line', source:'v', 'source-layer':'transportation',
      filter:['in','class','street','street_limited','service','residential','living_street','unclassified','minor'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#b8b0a0',
        'line-width':['interpolate',['linear'],['zoom'],13,0.5,10,2,14,5,18,12] } },

    // ── Roads — fills ─────────────────────────────────────────────────────
    { id: 'r-track', type: 'line', source: 'v', 'source-layer': 'transportation',
      filter: ['==', 'class', 'track'], minzoom: 12,
      layout: { 'line-join': 'round', 'line-cap': 'round' },
      paint: { 'line-color': '#e8e0d4', 'line-width': 1, 'line-dasharray': [4, 2] } },
    { id: 'r-path', type: 'line', source: 'v', 'source-layer': 'transportation',
      filter: ['in', 'class', 'path', 'footway', 'pedestrian', 'cycleway'], minzoom: 15,
      layout: { 'line-join': 'round', 'line-cap': 'round' },
      paint: { 'line-color': '#d8d0c4', 'line-width': 0.8, 'line-dasharray': [3, 2] } },
    { id:'r-street', type:'line', source:'v', 'source-layer':'transportation',
      filter:['in','class','street','street_limited','service','residential','living_street','unclassified','minor'],
      minzoom:13,
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#f8f4ee',
        'line-width':['interpolate',['linear'],['zoom'],6,0.4,10,1.8,14,3.6,18,9.9] } },
    { id:'r-tertiary', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','tertiary'],
      minzoom:10,
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#f8f4ee',
        'line-width':['interpolate',['linear'],['zoom'],6,0.4,10,1.5,14,3,18,8.25] } },
    { id:'r-local', type:'line', source:'v', 'source-layer':'transportation',
      filter:['in','class','unclassified','minor'],
      minzoom:12,
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#f8f4ee',
        'line-width':['interpolate',['linear'],['zoom'],6,0.4,10,1.8,14,3.6,18,9.9] } },
    { id:'r-secondary', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','secondary'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#d4a000',
        'line-width':['interpolate',['linear'],['zoom'],6,0.5,10,2,14,4,18,11] } },
    { id:'r-secondary-local', type:'line', source:'v', 'source-layer':'transportation',
      filter:['==','class','secondary'],
      layout:{ 'line-join':'round', 'line-cap':'round' },
    ...
    { id:'r-primary', type:'line', source:'v', 'source-layer':'transportation',
      filter:['all',['==','class','primary'],['!=','brunnel','tunnel']],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#e07b00',
        'line-width':['interpolate',['linear'],['zoom'],6,1,10,2,14,5,18,14] } },
    { id:'r-trunk', type:'line', source:'v', 'source-layer':'transportation',
      filter:['all',['==','class','trunk'],['!=','brunnel','tunnel']],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#3a81fc',
        'line-width':['interpolate',['linear'],['zoom'],6,1.5,10,3,14,7,18,15] } },
    { id:'r-motorway', type:'line', source:'v', 'source-layer':'transportation',
      filter:['all',['==','class','motorway'],['!=','brunnel','tunnel']],
      layout:{ 'line-join':'round', 'line-cap':'round' },
      paint:{ 'line-color':'#609e3f',
        'line-width':['interpolate',['linear'],['zoom'],6,2,10,4,14,8,18,17] } },
    ...
    // ── Road shields (road number plates) ──────────────────────────────────
    { id:'shield-motorway', type:'symbol', source:'v', 'source-layer':'transportation_name',
      filter:['all',['==','class','motorway'],['has','ref']],
      minzoom:9,
      layout:{
