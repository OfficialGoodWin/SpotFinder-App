  ...
  return {
    ...
    layers: [
      ...
      { id:'rc-secondary-local', type:'line', source:'v', 'source-layer':'transportation',
        ...
        paint:{ 'line-color': c.secondaryLine,
      ...
      { id: 'r-path', type: 'line', source: 'v', 'source-layer': 'transportation',
        filter: ['in', 'class', 'path', 'footway', 'pedestrian', 'steps'], minzoom: 14,
        layout: { 'line-join': 'round', 'line-cap': 'round' },
        paint: { 'line-color': c.path, 'line-width': ['interpolate',['linear'],['zoom'], 14,1, 16,1.5, 18,2.5], 'line-dasharray': [4, 3] } },
